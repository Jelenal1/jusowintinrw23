		...
		<div className={style.main}>
			...
			<div className={style.quote}>
				<div className='ml-2 mb-2 flex flex-col'>
					...
					<span className='text-xs'>18 (bei Wahl)</span>
				</div>
			...
			<div className={style.paragraphwrapper}>
				...
				Ich mache eine Infromatik Ausbildung, code auch in meiner Freizeit gerne, produziere Musik und bin im Vorstand der Juso Winterthur. Gröstenteils bin ich aber Antifaschistin ✊🌈
				</p>
			</div>
			...
			<div className={style.paragraphwrapper}>
				...
				<p className={style.paragraph}>
				Ich kandidiere weil es mir auf die Nerven geht, wie viele Parlamentarier*innen die Probleme der Menschen Missachten und nur für Eignene kapitalistische menschenfeindliche Ihre Stimme erheben.
				Ich habe sehr viele Privilegien, ich bin weiss, habe einen Schweizer-Pass... Ich möchte diese Privilegien für die Nutzen, die sie nicht haben.
				</p>
			</div>
