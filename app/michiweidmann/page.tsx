  ...
  return (
    <div className={style.main}>
      <div className={style.quotecard}>
        <img src="/img/M-Weidmann.jpg" className={style.image} />
      ...
      <div className={style.paragraphwrapper}>
        ...
        <p className={style.paragraph}>
          Studieren, an der Bar arbeiten, Vorstand Juso Winti, Festivals und
          Konzerte, Skifahren, Reisen und viel Lesen und Hören (Musik, Podcasts
          und Hörbücher).
        </p>
      </div>
      ...
      <div className={style.paragraphwrapper}>
        ...
        <p className={style.paragraph}>
          Ich kandidiere, weil wir in einer vom Kapitalismus beherrschten Welt
          mit unheimlich vielen Krisen, endlich Alternativen zu diesem System
          aufzeigen müssen!
        </p>
      </div>
      ...
      <div className={style.paragraphwrapper}>
        ...
        <p className={style.paragraph}>
          Ich stehe für Gleichberechtigung und Inklusion auf allen Ebenen,
          gleiche Chancen für alle, eine sozial gerechte Klimapolitik, mehr
          Queerness, gerechtere Verteilung des Vermögens und gegen Nazis und
          Rechtsextremismus in allen Formen.
        </p>
      </div>
    </div>
  );
