export default function securitypolicy() {
	return (
			<div className="p-1">
  <h1 className="text-2xl font-bold lg:text-3xl text-center my-4">Datenschutzerklärung</h1>
  <h2 className="text-2xl font-bold my-2" id="m716" >Präambel</h2>
  <p>
  ...
  <h2 id="m3" className="text-2xl font-bold">Verantwortlicher</h2>
  <h2 id="m2427" className="text-2xl font-bold">Maßgebliche Rechtsgrundlagen</h2>
  <p>
    <strong>
      Maßgebliche Rechtsgrundlagen nach dem Schweizer Datenschutzgesetz:{" "}
    </strong>
    Wenn Sie sich in der Schweiz befinden, bearbeiten wir Ihre Daten auf
    Grundlage des Bundesgesetzes über den Datenschutz (kurz "Schweizer DSG",
    Geltung ab dem 01. September 2023). Dies gilt auch, wenn unsere Bearbeitung
    Ihrer Daten Sie sonst in der Schweiz betrifft und Sie von der Bearbeitung
    betroffen sind. Das Schweizer DSG sieht grundsätzlich nicht vor (anders als
    beispielsweise die DSGVO), dass eine Rechtsgrundlage für die Bearbeitung der
    Personendaten genannt werden muss. Wir bearbeiten Personendaten ist nur
    dann, wenn die Bearbeitung rechtmäßig ist, nach Treu und Glauben
    durchgeführt wird und verhältnismäßig ist (Art. 6 Abs. 1 und 2 des Schweizer
    DSG). Ferner werden Personendaten von uns nur zu einem bestimmten und für
    die betroffene Person erkennbaren Zwecken beschafft und werden nur so
    bearbeitet, dass es mit diesen Zwecken vereinbar ist (Art. 6 Abs. 3 des
    Schweizer DSG).
  </p>
  <h2 className="text-2xl font-bold my-2" id="mOverview" >Übersicht der Verarbeitungen</h2>
  <p>
  ...
  <h2 className="text-2xl font-bold my-2" id="m25" >Übermittlung von personenbezogenen Daten</h2>
  <p>
  ...
  <h2 className="text-2xl font-bold my-2" id="m24">Internationale Datentransfers</h2>
  <p>
    Bekanntgabe von Personendaten ins Ausland: Gemäß dem Schweizer
    Datenschutzgesetz (DSG) geben wir personenbezogene Daten nur dann ins
    Ausland bekannt, wenn ein angemessener Schutz der betroffenen Personen
    gewährleistet ist (Art. 16 Schweizer DSG). Sofern der Bundesrat keinen
    angemessenen Schutz feststellt, ergreifen wir alternative
    Sicherheitsmaßnahmen. Diese können internationale Verträge, spezifische
    Garantien, Datenschutzklauseln in Verträgen, von der Eidgenössischen
  ...
  <p>
    Laut Art. 16 des Schweizer DSG können Ausnahmen für die Bekanntgabe von
    Daten ins Ausland zugelassen werden, wenn bestimmte Bedingungen erfüllt
    sind, einschließlich Einwilligung der betroffenen Person,
    Vertragsabwicklung, öffentliches Interesse, Schutz von Leben oder
    körperlicher Unversehrtheit, öffentlich gemachte Daten oder Daten aus einem
    gesetzlich vorgesehenen Register. Diese Bekanntgaben erfolgen stets im
    Einklang mit den gesetzlichen Anforderungen.
  </p>
  <h2 className="text-2xl font-bold my-2" id="m134">Einsatz von Cookies</h2>
  <p>
  ...
  <h2 className="text-2xl font-bold my-2" id="m104">Blogs und Publikationsmedien</h2>
  <p>
